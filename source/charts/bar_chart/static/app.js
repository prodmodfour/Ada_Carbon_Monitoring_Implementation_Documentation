...
const dailyData = {
  electricity: {
    ...
    datasets: [
      { label: "Idle (kWh)", data: [0.2,0.2,0.2,0.2,0.3,0.3,0.4,0.5,0.8,0.7,0.6,0.5,0.6,0.7,0.8,0.9,1.1,1.2,1.0,0.8,0.6,0.4,0.3,0.2], backgroundColor: "rgba(54, 162, 235, 0.6)" },
      { label: "Busy (kWh)", data: [0.1,0.1,0.1,0.1,0.2,0.4,0.6,1.1,2.5,2.2,2.0,1.5,1.8,2.3,2.8,3.0,3.2,2.9,2.5,1.8,1.2,0.8,0.4,0.2], backgroundColor: "rgba(255, 99, 132, 0.6)" },
    ],
  },
  carbon: {
    labels: Array.from({ length: 24 }, (_, i) => `${i}:00`),
    datasets: [
      { label: "Idle (gCO2eq)", data: [40,40,40,40,60,60,80,100,160,140,120,100,120,140,160,180,220,240,200,160,120,80,60,40], backgroundColor: "rgba(75, 192, 192, 0.6)" },
      { label: "Busy (gCO2eq)", data: [20,20,20,20,40,80,120,220,500,440,400,300,360,460,560,600,640,580,500,360,240,160,80,40], backgroundColor: "rgba(255, 159, 64, 0.6)" },
    ],
  },
};
